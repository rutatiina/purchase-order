        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-drawer3 mr-2"></i> <span class="font-weight-semibold">Purchase Orders</span></h4>
...
<script>
    ...
    export default {
        name: 'AccountingSalesPurchaseOrders',
        //components: {},
        data() {
            return {}
        },
        ...
        methods: {
            onRowClick(txn) {
                //console.log(txn)
                this.$router.push({ path: '/purchase-orders/'+txn.id })
            }
        },
        ready:function(){},
